% Artefakte & Abenteuer
% Ein Spielleiterhandbuch für Old-School Rollenspiele
%
...
Schätze und Magische Gegenstände
--------------------------------
...
1.  [Check Wandelnde Monster (1W6)]{.c0}
2.  [Spieler beschreiben ihre Aktionen]{.c0}
3.  [Es wird \...]{.c0}

<!-- -->

1.  [ein neuer Höhlenabschnitt beschrieben,]{.c0}
2.  eine Begegnung [abgehandelt,]{.c0}
3.  [etwas entdeckt,]{.c0}
4.  [weiter gemacht bei 1.]{.c0}

[Lauschen]{.c5} {#h.tscdt15ahkxc .c4}
-------------------------------

[erfolgreich bei 1 auf 1W6, Halbmenschen bei 1-2 auf 1W6]{.c0}

[Türen]{.c5} {#h.9zqv93nsfyip .c4}
-----------------------------

[Geheimtüren finden 1 auf 1W6, Elfen bei 1-2 auf 1W6.]{.c0}

[Zwerge finden große Fallen, Schiebewände, abfallende Gänge und neue
Einbauten bei 1-2 auf 1W6 ]{.c0}

[Türen aufbrechen bei 5-6 auf 1W6, ggf. Stärkebonus einrechnen.]{.c0}

[Verstecken]{.c5} {#h.wbgcnskmr26k .c4}
-------------------------------

[Halbling: im Verlies 1-2 auf 1W6, im Freien 1-9 auf 1W10]{.c0}

[Dieb, Stufe 1: 10%, Stufe 2: 15%, Stufe 3: 20% ]{.c0}

[Eine Begegnung]{.c5} {#h.qs3cwjnbo6pt .c4}
-------------------------------

1.  [Anzahl der Monster?]{.c0}
2.  [Überraschung? (je 1W6)]{.c0}
3.  [Reaktionen? (2W6)]{.c0}
4.  [Wenn ...]{.c0}

<!-- -->

1.  [beide Seiten verhandeln, weitere Reaktionswürfe ]{.c0}
2.  [eine Seite die Flucht ergreift, Flucht und Verfolgung
    abhandeln]{.c0}
3.  [eine Seite angreift, der Kampf abhandeln.]{.c0}

[Begegnungsentfernungen]{.c5} {#h.cxaot6rxldz9 .c4}
--------------------------------

[Dungeon: 2W6 \* 10', Wildnis: 4W6 \* 10 Meter (Überraschung: 1W4 \* 10
Meter)]{.c0}

[Eine Kampfrunde (6-10 sek.)]{.c5} {#h.kmynbcaa7zzy .c4}
-----------------------------------

1.  [Vorhaben klären, Sprüche deklarieren]{.c0}
2.  [Initiative?]{.c0}
3.  [Aktionen:]{.c0}

<!-- -->

1.  [Moral-Check für Monster / NSC]{.c0}
2.  [Bewegung und Kampfmanöver]{.c0}
3.  [Fernkampfangriffe]{.c0}
4.  [Sprüche und Stäbe]{.c0}
5.  [Nahkampf]{.c0}

<!-- -->

4.  [Ergebnisse abhandeln]{.c0}

[Wandelnde Monster]{.c5} {#h.6fi4owkdq68e .c4}
----------------------------

[Dungeon: alle 2 Phasen bei 1 auf W6]{.c0}
...
[Überraschung]{.c5} {#h.2xgo2dwcrhbh .c4}
---------------------------------

[bei 1-2 auf 1W6]{.c0}

[Reaktionen]{.c5} {#h.o37pg91fv03n .c4}
-----------------------------

[]{#t.d1d8932b78a41842b6a151baeb30994105aa83ec}[]{#t.0}
...
| [2]{.c0}                          | [feindselig]{.c0}                 |
+-----------------------------------+-----------------------------------+
| [3-5]{.c0}                        | [unfreundlich]{.c0}               |
+-----------------------------------+-----------------------------------+
| [6-8]{.c0}                        | [indifferent]{.c0}                |
+-----------------------------------+-----------------------------------+
| [9-11]{.c0}                       | [freundlich]{.c0}                 |
+-----------------------------------+-----------------------------------+
| [12]{.c0}                         | [hilfsbereit]{.c0}                |
+-----------------------------------+-----------------------------------+

[]{.c0}

[Initiative]{.c5} {#h.v4vyjh7qgg28 .c4}
--------------------------------
\index{Initiative}

[je Seite 1W6, die höhere Zahl gewinnt die Initiative]{.c0}

[Moral]{.c5} {#h.lyd9fl71ne6 .c4}
-------------------------------
\index{Moral}

2W6 - ist das Ergebnis [höher]{.c37}[ als der Moralwert des Monsters
ergreift es die Flucht, ergibt sich, o.ä.]{.c0}

1.  [Check bei erster Verletzung bzw. Kampfunfähigkeit des ersten
    Individuums einer Gruppe]{.c0}
2.  [Check bei Verlust von 50 % der TP bzw. Kampfunfähigkeit der Hälfte
    der Individuen einer Gruppe]{.c0}
...
-----   --------------------------------------
 ...
 3	animals that will fight when cornered
 4	herbivores defending their young
...
[Fernkampfreichweite]{.c5} {#h.sdcm5tmnirwh .c4}
-------------------------------------

[]{#t.6050be74f9c1ccb49995c2230c4bd5bf4d85629c}[]{#t.1}

+-----------------+-----------------+-----------------+-----------------+
| [Waffe]{.c0}    | [kurz           | [mittel         | [weit           |
|                 | (+1)]{.c0}      | (0)]{.c0}       | (-1)]{.c0}      |
+-----------------+-----------------+-----------------+-----------------+
| [Armbrust]{.c0} | [60]{.c0}       | [120]{.c0}      | [180]{.c0}      |
+-----------------+-----------------+-----------------+-----------------+
| [Langbogen]{.c0 | [70]{.c0}       | [140]{.c0}      | [210]{.c0}      |
| }               |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| [Kurzbogen]{.c0 | [50]{.c0}       | [100]{.c0}      | [150]{.c0}      |
| }               |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| [Schleuder]{.c0 | [40]{.c0}       | [80]{.c0}       | [120]{.c0}      |
| }               |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| [Speer]{.c0}    | [20]{.c0}       | [40]{.c0}       | [60]{.c0}       |
+-----------------+-----------------+-----------------+-----------------+
| [Öl/Weihwasser] | [10]{.c0}       | [30]{.c0}       | [50]{.c0}       |
| {.c0}           |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+
| [Kriegsbeil/Dol | [10]{.c0}       | [20]{.c0}       | [30]{.c0}       |
| ch]{.c0}        |                 |                 |                 |
+-----------------+-----------------+-----------------+-----------------+

[]{.c0}

[Fallschaden]{.c5} {#h.6waj34qcpsl8 .c4}
--------------------------------

[1W6 pro 10' Fallhöhe]{.c0}

[Untote vertreiben]{.c5} {#h.h1t68xjxw0cs .c4}
-----------------------------------
...
[Es werden 2W6 Trefferwürfel an Untoten vertrieben]{.c0}

[Wurfgeschosse]{.c5} {#h.yut2nbrr2jvo .c4}
------------------------------------------

[Weihwasser: Trefferwurf wie Fernkampf, 1W8 Schaden bei Untoten.]{.c0}

[Öl: Trefferwurf wie Fernkampf, tropft innerhalb von 2 Runden ab,
brennendes Öl macht 1W8 Schaden]{.c0}

[Flucht und Verfolgung]{.c5} {#h.gcj31uu8dvhf .c4}
-----------------------------------------
...
[Verirren in der Wildnis]{.c5} {#h.2v824c6ni6eo .c4}
---------------------------------------

[]{#t.3fb5361ef5199340d1f28e0ae4a86376a0564377}[]{#t.3}

+-----------------------------------+-----------------------------------+
| [1W6]{.c0}                        | [Landschaft]{.c0}                 |
+-----------------------------------+-----------------------------------+
| [1]{.c0}                          | [Offen / Steppe]{.c0}             |
+-----------------------------------+-----------------------------------+
| [1-3]{.c0}                        | [Sumpf, Dschungel, Wüste]{.c0}    |
+-----------------------------------+-----------------------------------+
| [1-2]{.c0}                        | [alle anderen]{.c0}               |
+-----------------------------------+-----------------------------------+

[Ausweichen in der Wildnis]{.c5} {#h.kty3swgnknns .c34}
-------------------------------------------

[Nur wenn Gruppe nicht überrascht:]{.c0}

[]{#t.e390197ef92e5eae92eac7e1d3249755a2705030}[]{#t.4}
